...
const BackgroundContainerHome=(props)=>{
    const {icon}=props;
    return(
        <Grid container style={{width: "100vw", height: "100vh", position: "absolute", top: 0, zIndex: 0}}>
...
export default BackgroundContainerHome;